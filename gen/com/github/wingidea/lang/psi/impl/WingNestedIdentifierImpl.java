...
public class WingNestedIdentifierImpl extends WingElementImpl implements WingNestedIdentifier {

  public WingNestedIdentifierImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull WingVisitor visitor) {
    visitor.visitNestedIdentifier(this);
  }
  ...
  @Override
  @Nullable
  public WingJsonTypes getJsonTypes() {
    return findChildByClass(WingJsonTypes.class);
  }

  @Override
  @Nullable
  public WingMemberIdentifier getMemberIdentifier() {
    return findChildByClass(WingMemberIdentifier.class);
  }
