...
public class WingJsonLiteralMemberImpl extends WingElementImpl implements WingJsonLiteralMember {

  public WingJsonLiteralMemberImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull WingVisitor visitor) {
    visitor.visitJsonLiteralMember(this);
  }
