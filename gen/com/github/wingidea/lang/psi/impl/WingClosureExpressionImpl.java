...
public class WingClosureExpressionImpl extends WingExpressionImpl implements WingClosureExpression {

  public WingClosureExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public WingClosureModifier getClosureModifier() {
    return findChildByClass(WingClosureModifier.class);
  }
