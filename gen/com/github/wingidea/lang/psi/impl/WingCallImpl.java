...
public class WingCallImpl extends WingElementImpl implements WingCall {

  public WingCallImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public WingSuperCall getSuperCall() {
    return findChildByClass(WingSuperCall.class);
  }
