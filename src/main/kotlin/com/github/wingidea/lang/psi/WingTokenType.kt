...
val WING_KEYWORDS = create(LET, NEW, INFLIGHT_SPECIFIER, INTERFACE, CLASS, ELSE, DEFER, IF, ELIF, BRING, CATCH, BREAK, CONTINUE, FOR, IN, RETURN, STATIC, VAR, WHILE, TRY, FINALLY, EXTENDS, IMPLEMENTS, ENUM, EXTERN, ALIAS, PUBLIC, PROTECTED, STRUCT)
