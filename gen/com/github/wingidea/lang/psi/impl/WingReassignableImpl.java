...
public class WingReassignableImpl extends WingElementImpl implements WingReassignable {

  public WingReassignableImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull WingVisitor visitor) {
    visitor.visitReassignable(this);
  }
