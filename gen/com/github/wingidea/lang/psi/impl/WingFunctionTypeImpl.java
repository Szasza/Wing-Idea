...
public class WingFunctionTypeImpl extends WingElementImpl implements WingFunctionType {
  ...
  public WingFunctionTypeImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public WingParameterTypeList getParameterTypeList() {
    return findNotNullChildByClass(WingParameterTypeList.class);
  }
