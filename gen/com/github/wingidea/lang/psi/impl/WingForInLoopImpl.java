...
public class WingForInLoopImpl extends WingElementImpl implements WingForInLoop {

  public WingForInLoopImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull WingVisitor visitor) {
    visitor.visitForInLoop(this);
  }
  ...
  @Override
  @Nullable
  public WingLoopRange getLoopRange() {
    return findChildByClass(WingLoopRange.class);
  }
