...
public class WingReferenceExpressionImpl extends WingExpressionImpl implements WingReferenceExpression {
  ...
  @Override
  @Nullable
  public WingNestedIdentifier getNestedIdentifier() {
    return findChildByClass(WingNestedIdentifier.class);
  }

  @Override
  @Nullable
  public WingReferenceIdentifier getReferenceIdentifier() {
    return findChildByClass(WingReferenceIdentifier.class);
  }
