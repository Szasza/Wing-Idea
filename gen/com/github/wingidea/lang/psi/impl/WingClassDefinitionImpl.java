...
public class WingClassDefinitionImpl extends WingElementImpl implements WingClassDefinition {

  public WingClassDefinitionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public WingClassModifiers getClassModifiers() {
    return findChildByClass(WingClassModifiers.class);
  }
