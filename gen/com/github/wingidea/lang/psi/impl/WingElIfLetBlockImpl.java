...
public class WingElIfLetBlockImpl extends WingElementImpl implements WingElIfLetBlock {

  public WingElIfLetBlockImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull WingVisitor visitor) {
    visitor.visitElIfLetBlock(this);
  }
