...
public class WingIfStatementImpl extends WingElementImpl implements WingIfStatement {
  ...
  public WingIfStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<WingBlockStatement> getBlockStatementList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, WingBlockStatement.class);
  }
