...
public class WingArgumentImpl extends WingElementImpl implements WingArgument {
  ...
  public WingArgumentImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public WingKeywordArgument getKeywordArgument() {
    return findChildByClass(WingKeywordArgument.class);
  }

  @Override
  @Nullable
  public WingPositionalArgument getPositionalArgument() {
    return findChildByClass(WingPositionalArgument.class);
  }
