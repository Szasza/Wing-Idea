...
public class WingArgumentListImpl extends WingElementImpl implements WingArgumentList {
  ...
  public WingArgumentListImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<WingArgument> getArgumentList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, WingArgument.class);
  }
