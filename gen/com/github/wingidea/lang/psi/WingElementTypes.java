...
public interface WingElementTypes {
  ...
  IElementType ARRAY_LITERAL = new WingElementType("ARRAY_LITERAL");
  ...
  IElementType BLOCK = new WingElementType("BLOCK");
  IElementType BREAK_STATEMENT = new WingElementType("BREAK_STATEMENT");
  IElementType CALL = new WingElementType("CALL");
  IElementType CATCH_BLOCK = new WingElementType("CATCH_BLOCK");
  IElementType CLASS_DEFINITION = new WingElementType("CLASS_DEFINITION");
  ...
  IElementType CLOSURE = new WingElementType("CLOSURE");
  IElementType CLOSURE_MODIFIERS = new WingElementType("CLOSURE_MODIFIERS");
  IElementType COLLECTION_LITERAL = new WingElementType("COLLECTION_LITERAL");
  ...
  IElementType ENUM_DEFINITION = new WingElementType("ENUM_DEFINITION");
  ...
  IElementType FOR_IN_LOOP = new WingElementType("FOR_IN_LOOP");
  ...
  IElementType INTERFACE_DEFINITION = new WingElementType("INTERFACE_DEFINITION");
  ...
  IElementType INTRINSIC = new WingElementType("INTRINSIC");
  IElementType JSON_LITERAL = new WingElementType("JSON_LITERAL");
  ...
  IElementType JSON_TYPES = new WingElementType("JSON_TYPES");
  IElementType KEYWORD_ARGUMENT = new WingElementType("KEYWORD_ARGUMENT");
  IElementType LIFT_QUALIFICATION = new WingElementType("LIFT_QUALIFICATION");
  IElementType LIFT_QUALIFICATIONS = new WingElementType("LIFT_QUALIFICATIONS");
  IElementType LIFT_STATEMENT = new WingElementType("LIFT_STATEMENT");
  IElementType LITERAL = new WingElementType("LITERAL");
  ...
  IElementType MAP_LITERAL = new WingElementType("MAP_LITERAL");
  ...
  IElementType MEMBER_IDENTIFIER = new WingElementType("MEMBER_IDENTIFIER");
  IElementType METHOD_DEFINITION = new WingElementType("METHOD_DEFINITION");
  IElementType METHOD_MODIFIERS = new WingElementType("METHOD_MODIFIERS");
  IElementType NESTED_IDENTIFIER = new WingElementType("NESTED_IDENTIFIER");
  ...
  IElementType OPTIONAL_UNWRAP = new WingElementType("OPTIONAL_UNWRAP");
  ...
  IElementType POSITIONAL_ARGUMENT = new WingElementType("POSITIONAL_ARGUMENT");
  IElementType REASSIGNABLE = new WingElementType("REASSIGNABLE");
  IElementType REFERENCE_EXPRESSION = new WingElementType("REFERENCE_EXPRESSION");
  IElementType REFERENCE_IDENTIFIER = new WingElementType("REFERENCE_IDENTIFIER");
  ...
  IElementType STRUCT_DEFINITION = new WingElementType("STRUCT_DEFINITION");
  IElementType STRUCT_FIELD = new WingElementType("STRUCT_FIELD");
  IElementType STRUCT_LITERAL = new WingElementType("STRUCT_LITERAL");
  IElementType STRUCT_LITERAL_MEMBER = new WingElementType("STRUCT_LITERAL_MEMBER");
  IElementType SUPER_CALL = new WingElementType("SUPER_CALL");
  ...
  IElementType TYPE_IDENTIFIER = new WingElementType("TYPE_IDENTIFIER");
  IElementType TYPE_INTRINSIC = new WingElementType("TYPE_INTRINSIC");
  ...
  class Factory {
    public static PsiElement createElement(ASTNode node) {
      ...
      if (type == ACCESSOR) {
        ...
        return new WingArrayLiteralImpl(node);
      }
        ...
        return new WingClosureImpl(node);
      }
      else if (type == CLOSURE_MODIFIERS) {
        return new WingClosureModifiersImpl(node);
      }
      else if (type == COLLECTION_LITERAL) {
        return new WingCollectionLiteralImpl(node);
      }
        ...
        return new WingEnumDefinitionImpl(node);
      }
      else if (type == ENUM_FIELD) {
        return new WingEnumFieldImpl(node);
      }
      else if (type == EXPRESSION) {
        return new WingExpressionImpl(node);
      }
        ...
        return new WingForInLoopImpl(node);
      }
        ...
        return new WingInterfaceDefinitionImpl(node);
      }
        ...
        return new WingIntrinsicImpl(node);
      }
      else if (type == JSON_LITERAL) {
        return new WingJsonLiteralImpl(node);
      }
      ...
      else if (type == JSON_TYPES) {
        return new WingJsonTypesImpl(node);
      }
      else if (type == KEYWORD_ARGUMENT) {
        return new WingKeywordArgumentImpl(node);
      }
      else if (type == LIFT_QUALIFICATION) {
        return new WingLiftQualificationImpl(node);
      }
      else if (type == LIFT_QUALIFICATIONS) {
        return new WingLiftQualificationsImpl(node);
      }
      else if (type == LIFT_STATEMENT) {
        return new WingLiftStatementImpl(node);
      }
      else if (type == LITERAL) {
        return new WingLiteralImpl(node);
      }
        ...
        return new WingMapLiteralImpl(node);
      }
      ...
      else if (type == MEMBER_IDENTIFIER) {
        return new WingMemberIdentifierImpl(node);
      }
      else if (type == METHOD_DEFINITION) {
        return new WingMethodDefinitionImpl(node);
      }
      else if (type == METHOD_MODIFIERS) {
        return new WingMethodModifiersImpl(node);
      }
      else if (type == NESTED_IDENTIFIER) {
        return new WingNestedIdentifierImpl(node);
      }
      ...
      else if (type == OPTIONAL_UNWRAP) {
        return new WingOptionalUnwrapImpl(node);
      }
        ...
        return new WingPositionalArgumentImpl(node);
      }
      else if (type == REASSIGNABLE) {
        return new WingReassignableImpl(node);
      }
      else if (type == REFERENCE_EXPRESSION) {
        return new WingReferenceExpressionImpl(node);
      }
      else if (type == REFERENCE_IDENTIFIER) {
        return new WingReferenceIdentifierImpl(node);
      }
        ...
        return new WingTypeIdentifierImpl(node);
      }
      else if (type == TYPE_INTRINSIC) {
        return new WingTypeIntrinsicImpl(node);
      }
